...
import 'package:farnet/templateApps/doctorAppointment/screens/DocInfo.dart';
...
class _MyFirstPageState extends State<MyFirstPage> {
  ...
  Widget categoryContainer(String imgName, String title) {
    return Container(
      width: 130,
      child: Column(
        children: [
          Image.asset('assets/doctorApp/images/category/$imgName'),
          Text(
            title,
            style: TextStyle(
              fontWeight: FontWeight.w800,
  ...
  Widget createDocWidget(String imgName, String docName) {
    return Container(
      child: InkWell(
        child: Container(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(
                          'assets/doctorApp/images/docprofile/$imgName',
                        ),
                        fit: BoxFit.cover),
                  ),
                ),
